...
% \RequirePackage{cryptocode}  % Commented out: conflicts with algpseudocode
...
% \newcommand{\For}{\attacker{F}}  % Conflicts with algpseudocode \For
...
% \newcommand{\algorithm}[1]{\underline{\procfont{algorithm} {#1}:}}  % Conflicts with algorithm package
\newcommand{\algorithmv}[1]{\underline{\procfont{algorithm} {#1}:}\smallskip}
\providecommand{\comment}[1]{\texttt{// #1}}
